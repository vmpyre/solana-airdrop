...
> - `DELAY_IN_SECONDS_BETWEEN_TRANSACTIONS` - This is the delay in seconds between send transactions. Adjust this based on your RPC's ratelimits. The lower the delay, the faster the airdrop but if your RPC get's ratelimited by putting a lower delay, you'll get errors/failed transactions. If you are using SHYFT's RPC shared above, you should be able to do it pretty fast.
